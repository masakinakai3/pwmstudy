...
- **Web UI**: ブラウザから 8 パラメータ、PWM 方式、FFT 表示対象を変更し、主要 3 セクションを表示可能
...
依存ライブラリ: NumPy, Matplotlib, SciPy, pytest, FastAPI, Uvicorn, httpx
...
49 件のテスト（物理妥当性検証 + application 層 + API/UI 疎通）が実行されます。
